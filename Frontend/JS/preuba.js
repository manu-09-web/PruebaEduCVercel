document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener("click", (e) => {
        ...
        // A. ACCIÓN VER RESUMEN (Icono del ojo - Redirección o Modal)
        ...
        if (botonVer) {
            ...
            // Si existe el modal de resumen en pantalla, ábrelo dinámicamente
            if (modalVerResumen) {
                ...
                // Si no hay modal, redirige a la otra página
        ...
        // B. ACCIÓN EDITAR GRUPO (Icono del lápiz)
        ...
        // C. ACCIÓN ELIMINAR GRUPO (Icono del bote de basura)
        ...
        // D. CERRAR MODALES AL DAR CLICK EN EL FONDO OSCURO (Overlay)
...
document.addEventListener("DOMContentLoaded", () => {
    // Seleccionamos el botón de generar y la notificación
    ...
    if (btnGenerar && notificacion) {
        btnGenerar.addEventListener("click", () => {
            // Aseguramos limpiar cualquier estado previo si dan clics seguidos
            notificacion.classList.remove("mostrar");
            
            // Un pequeño delay para reiniciar la animación de entrada de CSS
            setTimeout(() => {
                // Muestra la notificación en la esquina inferior derecha
                notificacion.classList.add("mostrar");
                
                // Opcional: Aquí puedes agregar o disparar la renderización de tu gráfica de barras
                console.log("Generando reporte...");
            }, 100);

            // Oculta automáticamente la notificación después de 3.5 segundos
            setTimeout(() => {
                notificacion.classList.remove("mostrar");
            }, 3500);
        });
